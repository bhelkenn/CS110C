/**
	@file	BinaryTree.cpp
	implementation file for BinaryTree class
...
template<class ItemType>
ItemType BinaryTree<ItemType>::getRootData() const throw(TreeLogicException)
{
	if (isEmpty())
		throw TreeLogicException("TreeLogicException: Empty tree");
	return *pItem;
}
...
//ATTACH FUNCTIONS
template<class ItemType>
void BinaryTree<ItemType>::attachLeft(const ItemType& newItem) throw(TreeLogicException)
{
	if (isEmpty())
		throw TreeLogicException("TreeLogicException: Empty tree");
	else if (leftSubtreePtr != nullptr)
		throw TreeLogicException("TreeLogicException: Cannot overwrite left subtree");
	else //nonempty tree; no left child
		leftSubtreePtr = new BinaryTree(newItem);
}
template<class ItemType>
void BinaryTree<ItemType>::attachRight(const ItemType& newItem) throw(TreeLogicException)
{
	if (isEmpty())
		throw TreeLogicException("TreeLogicException: Empty tree");
	else if (rightSubtreePtr != nullptr)
		throw TreeLogicException("TreeLogicException: Cannot overwrite right subtree");
	else //nonempty tree; no right child
		rightSubtreePtr = new BinaryTree(newItem);
}
template<class ItemType>
void BinaryTree<ItemType>::attachLeftSubtree(BinaryTree<ItemType>& leftTree) throw(TreeLogicException)
{
	if (isEmpty())
		throw TreeLogicException("TreeLogicException: Empty tree");
	else if (leftSubtreePtr != nullptr)
...
template<class ItemType>
void BinaryTree<ItemType>::attachRightSubtree(BinaryTree<ItemType>& rightTree) throw(TreeLogicException)
{
	if (isEmpty())
		throw TreeLogicException("TreeLogicException: Empty tree");
	else if (rightSubtreePtr != nullptr)
...
//DETACTH FUNCTIONS
template<class ItemType>
void BinaryTree<ItemType>::detachLeftSubtree(BinaryTree<ItemType>& leftTree) throw(TreeLogicException)
{
	if (isEmpty())
		throw TreeLogicException("TreeLogicException: Empty tree");
	else
...
template<class ItemType>
void BinaryTree<ItemType>::detachRightSubtree(BinaryTree<ItemType>& rightTree) throw(TreeLogicException)
{
	if (isEmpty())
		throw TreeLogicException("TreeLogicException: Empty tree");
	else
...
template<class ItemType>
BinaryTree<ItemType>& BinaryTree<ItemType>::getLeftSubtree() throw(TreeLogicException)
{
	if (isEmpty())
	{
		throw TreeLogicException("TreeLogicException: Empty tree");
...
template<class ItemType>
BinaryTree<ItemType>& BinaryTree<ItemType>::getRightSubtree() throw(TreeLogicException)
{
	if (isEmpty())
	{
		throw TreeLogicException("TreeLogicException: Empty tree");
...
template<class ItemType>
void BinaryTree<ItemType>::findMax(ItemType& max)
{
	if (pItem != nullptr)
	{
		if (getRootData() > max)
			max = getRootData();
		if (rightSubtreePtr)
			rightSubtreePtr->findMax(max);
	}
}

template<class ItemType>
void BinaryTree<ItemType>::findSum(ItemType& sum)
{
	if (pItem != nullptr)
	{
		sum += getRootData();
		if (rightSubtreePtr)
			rightSubtreePtr->findSum(sum);
		if (leftSubtreePtr)
			leftSubtreePtr->findSum(sum);
	}
}
...
BinaryTree<ItemType>& BinaryTree<ItemType>::operator=(const BinaryTree<ItemType>& rhs) throw(UnsupportedOperationException)
{
	if (isSubtree(rhs))
	{
		string message = "UnsupportedOperationException: illegal assignment in BinaryTree";
